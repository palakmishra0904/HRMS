...
<?php
	...
	{
		echo "<script>window.location='HRemp_view.php';</script>";
	}
	else if(isset($_POST['delete']))
	{
		echo "<script>window.location='HRemp_view.php?empid=$empid';</script>";
	}
	else if(isset($_POST['edit']))
	{
		echo "<script>window.location='HRemp_add.php?empid=$empid';</script>";	
	}
...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="HRhome.php">Home</a><i class="fa fa-angle-right"></i>Tables<i class="fa fa-angle-right"></i>Employee View<i class="fa fa-angle-right"></i>Detail View</li>
</ol>
<form method="post">
