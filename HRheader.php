...
<!--Image Popup-->
<style>
.logo-w3-agile, .logo1, .profile_details {
    background-color: #28d5a5;
    background-image: linear-gradient(160deg, #28d5a5 0%, #68938e 100%);
}
.sidebar-icon{
    color: #000;
								...
								<ul>
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											<li> <a href="HRprofile.php"><i class="fa fa-user"></i> Profile</a> </li> 
