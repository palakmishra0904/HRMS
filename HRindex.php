...
body {
   min-height:100vh;
    ...
    background-image: linear-gradient(160deg, #00d87e 0%, #094e46d4 100%);
}
...
<body>
    ...
    <h1 class="text-white">Human Resource Management System - HR Side</h1>
    <br>
    <br>
<div class="login-block">
    ...
    <button type="submit" name="HRsubmit" class="login">Submit</button>
    </form>
</div>
<div>
        <h3><a href="main.php" style="color:#fff; text-decoration: none;">Back To Home Page.</a></h3>
    </div>
</body>
