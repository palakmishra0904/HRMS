						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li><a href="#"><i class="fa fa-list-alt"></i><span>Task</span><span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
											<ul>
												<li><a href="taskadd.php">Assign task</a></li>
												<li><a href="taskview.php">Task View</a></li>
											</ul>
										</li>
										...
										<li><a href="#"><i class="fa fa-list-alt"></i><span>Recruitment</span><span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
											<ul>
												<li><a href="recruitadd.php">Recruitment add</a></li>
												<li><a href="recruitview.php">Recruitment View</a></li>
											</ul>
										</li>
							        	...
							        	<li id="menu-academico" ><a href="changepassword.php"><i class="fa fa-cogs"></i><span>Change Password</span></a>
									 	</li>
