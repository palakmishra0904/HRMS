	...
	<div class="main-wthree">
		...
		<div class="sin-w3-agile">
			...
			<form action="controller/login.php" method="post">
				...
				<!-- <div class="clearfix"></div>
				<h5 class="text-center"><a href="./user" class="text-white" sty>Login as an Employee</a></h5>
				<div class="clearfix"></div> -->
			</form>
					<div class="back">
						<h4><a href="../main.php" style="color:#fff; text-decoration: none;">Back to home</a></h4>
					</div>
					<div class="footer">
