...
nav{
    	...
    	background-image: linear-gradient(160deg, #11cb52 0%, #3bbdae 100%);
}
</style>
<!-- End image popup -->
   ...
   <body class="size-1140">
      ...
      <header>
         <nav>
            <div class="line">
               <div class="s-12 l-5">
                  <h3 style="color: white;">SPI INFOTECH</h3>
               </div>
               <div class="top-nav s-12 l-3 right">
                  <div class="employee-name" style="margin-top: 13%;">
                     <a style="color: white; Font-size: 20px;">User <font color="#808B96">:</font> <?php echo ucfirst($_SESSION['User']['FirstName'])."&nbsp;".ucfirst($_SESSION['User']['LastName']); ?></a> |
                     <a href="../controller/logout.php" style="text-align: right; color: #000; font-size: 20px;"> Logout </a>
                  </div>
               </div>
            </div>
         </nav>
